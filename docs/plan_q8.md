...
* [x] For O projection, add fused Q8 dequant-dot kernels before residual add for both decode and prefill.
* [x] Preserve RoPE, KV-cache write, flash attention, and residual add unchanged.
