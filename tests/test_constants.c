...
static int test_language_model_constants(void) {
    ...
    CHECK(UOCR_SOURCE_TENSOR_COUNT == 2710u);
    CHECK(UOCR_FP16_RUNTIME_TENSOR_COUNT == 2709u);
    CHECK(UOCR_FP16_PRESERVED_UNUSED_TENSOR_COUNT == 1u);
    CHECK(UOCR_FP16_OMITTED_TENSOR_COUNT == 0u);
    CHECK(UOCR_FP16_TENSOR_PAYLOAD_BYTES == 6672212480ull);
    CHECK(UOCR_FP16_RUNTIME_TENSOR_COUNT + UOCR_FP16_PRESERVED_UNUSED_TENSOR_COUNT + UOCR_FP16_OMITTED_TENSOR_COUNT == UOCR_SOURCE_TENSOR_COUNT);
